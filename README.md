...
╔══════════════════════════════════════════════════════════════════╗
║                                                                  ║
║          ▶  VAULT-TEC PIP-BOY 3000   ::   USER PROFILE           ║
║                                                                  ║
║          NAME ............ ANDREA CLAIRE M. BAULITA              ║
║          ALIAS ........... ANDY  /  @sanashii                    ║
...
```
[ EARTHCHIMP // DUBLIN ]   AI AUTOMATIONS SPECIALIST       2026 — present
[ MULTIPLAI.TECH       ]   AI AUTOMATION ENGINEER          2025 — 2026
[ TRAX TECH ASIA       ]   JR. PLATFORM ENGINEER           2024 — 2025
```

I build self-hosted **n8n** pipelines, **LLM orchestrations** against Claude / GPT-4, and the production infra that keeps them online — Docker Compose, Nginx reverse proxies, Supabase, hardened Linux. Lately I've been deep in autonomous discovery systems (Thompson Sampling + LLM screening) and Amazon SP-API restricted-roles compliance.
...
```
AUTOMATION  ::  n8n (self-hosted)  ·  Make.com  ·  agentic workflows  ·  structured-JSON prompting
LANGUAGES   ::  Python  ·  JavaScript / Node.js  ·  Bash  ·  SQL  ·  Regex
DATA        ::  Supabase / PostgREST  ·  PostgreSQL  ·  MySQL  ·  Pandas  ·  scikit-learn
INFRA       ::  Docker Compose  ·  Nginx (SSL / reverse proxy)  ·  Linux (Ubuntu/Debian)  ·  cron
SECURITY    ::  auditd  ·  Fail2ban  ·  SSH hardening  ·  GDPR / DPP authoring  ·  SP-API roles
LLM         ::  Claude 3.5/4  ·  GPT-4  ·  prompt engineering  ·  agent design
FRONT-END   ::  React  ·  Next.js  ·  Tailwind  ·  Figma
```
